...
const imageFolder = path.join(__dirname, '../images/operators/');
...
module.exports.attack = {
    ...
    blackbeard: {
        ...
        icon: imageFolder + 'blackbeard.png',
        specialties: [
            "Support"
        ],
        stats: {
...
module.exports.defense = {
    ...
    thunderbird: {
        ...
        icon: imageFolder + 'thunderbird.png',
        specialties: [
            "Support"
        ],
        stats: {
